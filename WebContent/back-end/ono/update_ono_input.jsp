...
<table>
	...
	<tr>
		<td>優惠卷編號:<font color=red><b>*</b></font></td>
		<td><input type="TEXT" name="couponSno" size="45" value="<%=onVO.getcouponSno()%>" /></td>
	</tr>
	<tr>
		<td>線上訂單時間:<font color=red><b>*</b></font></td>
		<td><input type="text" name="onoTime" size="45" value="<%=onVO.getonoTime()%>" /></td>
	</tr>
	<tr>
		<td>線上訂單總價:<font color=red><b>*</b></font></td>
		<td><input type="TEXT" name="onoTotal" size="45" value="<%=onVO.getonoTotal()%>" /></td>
	</tr>
	<tr>
		<td>線上訂單狀態:<font color=red><b>*</b></font></td>
		<td><input type="TEXT" name="onoStatus" size="45" value="<%=onVO.getonoStatus()%>" /></td>
	</tr>
	<tr>
		<td>線上訂單付款狀態:<font color=red><b>*</b></font></td>
		<td><input type="TEXT" name="onoPay" size="45" value="<%=onVO.getonoPay()%>" /></td>
	</tr>
</table>

<br>
<input type="hidden" name="action" value="update">
<input type="hidden" name="onono" value="<%=onVO.getonono()%>">
