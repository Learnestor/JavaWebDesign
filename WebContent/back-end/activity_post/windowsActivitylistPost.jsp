		...
		<div class="row">
 			...
 			<div class="floating-card">
			 	...
			 	<div id="actimagebox"class="col-xl-4 col-lg-6 innerdetail">
			 		<img src="<%=request.getContextPath()%>/back-end/activity_post/activitypostpicServlet.do?actPostno=${ACPVO.actPostno}" width="300px" height="250px">
			 	</div>
		 	...
		 	<div class="floating-card">
				 ...
				 <div class="col-xl-4 col-lg-6 innerdetail">
					...
					<table class="windowpad" width="300px" height="250px">
					 		...
					 		<tr class="trspace">
					 			<td class="tddes">${ACPVO.actPostCon}</td>
					 		</tr>
