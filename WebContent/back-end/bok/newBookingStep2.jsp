	...
	<div class="container-fluid" id="booking-container">
		<form id="newbooking" METHOD="post" ACTION="<%=request.getContextPath()%>/BokServlet_admin">
			...
			<div id="result">
				...
				<hr>		
				<input type="hidden" id="bkprice" name="bkprice" value="200" readonly="readonly">	
				<input type="hidden" name="action" value="liveOrder">
				<input type="hidden" name="memno" value="liveOrder">
