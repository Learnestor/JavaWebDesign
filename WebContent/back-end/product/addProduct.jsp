...
<form method="post" action="<%=request.getContextPath()%>/product.do"  enctype="multipart/form-data">
	<table id ="pdetail">
		<tr>
			...
			<td class="ptds">
			<input type="text" name="pname" size="41" placeholder ="請輸入商品名稱">
			</td>
			
			<td class="ptds">商品每日供給量:</td>
			<td class="ptds">
			<input type="text" name="pDoffer" size="41" placeholder = "請輸入商品的每日供給量">
			</td>
		...
		<tr>
			...
			<td class="ptds">
			<input type="range" name="invStatus" min="0" max="1" step="1">
			</td>
		...
		<tr>
			...
			<td class="ptds">
				<input type="text" name="pP" size="41" placeholder ="請輸入商品單價">	
			</td>
			
			<td class="ptds">上下架狀態:</td>
			<td class="ptds">
			<input type="range" name="pStatus" min="0" max="1" step="1">
			</td>
		...
		<tr>
			...
			<td class="ptds">
			<textarea id="productdes" name="pDes"  placeholder ="請為商品添加描述"></textarea>
			</td>
	...
	<script>
		function init(){
			...
			var proudctimg = document.createElement('img');
			preview.append(proudctimg);
